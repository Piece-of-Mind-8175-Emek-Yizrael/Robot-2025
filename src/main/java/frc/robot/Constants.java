...
public final class Constants {
  ...
  public static class VisionConstants {
    ...
    public static Translation3d l_camera_translation = new Translation3d(0.04, 0.02, 0.263);// x+5, y+10
    public static Translation3d r_camera_translation = new Translation3d(0.04, 0.002, 0.263);// x+3, y+5

    // THE ROTATION FOR THE LEFT AND RIGHT CAMERAS
    public static Rotation3d l_camera_rotation = new Rotation3d(Degrees.of(0), Degrees.of(0), Degrees.of(-15.6 + 27));
    public static Rotation3d r_camera_rotation = new Rotation3d(Degrees.of(0), Degrees.of(0), Degrees.of(9.4 - 23.1));
