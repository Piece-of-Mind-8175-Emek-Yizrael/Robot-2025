...
public class ElevatorIOSim implements ElevatorIO {
    ...
    public ElevatorIOSim() {
        ...
        funnelPose = new Pose3d(0,0,0, new Rotation3d());
    }
    ...
    public void setGoal(double goal){
        pid.setGoal(goal);
        setVoltage(pid.calculate(elevator.getPositionMeters()));
    }
    ...
    public void updateInputs(ElevatorIOInputs inputs) {
        ...
        Logger.recordOutput("Elevator/Elevator position",elevator.getPositionMeters());//TODO change value of pose realtime
        Logger.recordOutput("Funnel pose",funnelPose);//TODO change value of pose realtime
